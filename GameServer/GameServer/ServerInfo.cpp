...
void CServerInfo::ReadItemInfo() // OK
{
	...
	gCustomPet.Load(gPath.GetFullPath("Item\\PetItemOption.txt")); //CustomPets
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_JewelVisualItemIndexAdd = GetPrivateProfileInt(section, "JewelVisualItemIndexAdd", 0, path);

	this->m_JewelVisualItemIndexRemove = GetPrivateProfileInt(section, "JewelVisualItemIndexRemove", 0, path);

	this->m_JewelVisualAddOptionSuccessRate[0] = GetPrivateProfileInt(section, "JewelVisualAddOptionSuccessRate_AL0", 0, path);

	this->m_JewelVisualAddOptionSuccessRate[1] = GetPrivateProfileInt(section, "JewelVisualAddOptionSuccessRate_AL1", 0, path);

	this->m_JewelVisualAddOptionSuccessRate[2] = GetPrivateProfileInt(section, "JewelVisualAddOptionSuccessRate_AL2", 0, path);

	this->m_JewelVisualAddOptionSuccessRate[3] = GetPrivateProfileInt(section, "JewelVisualAddOptionSuccessRate_AL3", 0, path);

	this->m_JewelVisualRemoveOptionSuccessRate[0] = GetPrivateProfileInt(section, "JewelVisualRemoveOptionSuccessRate_AL0", 0, path);

	this->m_JewelVisualRemoveOptionSuccessRate[1] = GetPrivateProfileInt(section, "JewelVisualRemoveOptionSuccessRate_AL1", 0, path);

	this->m_JewelVisualRemoveOptionSuccessRate[2] = GetPrivateProfileInt(section, "JewelVisualRemoveOptionSuccessRate_AL2", 0, path);

	this->m_JewelVisualRemoveOptionSuccessRate[3] = GetPrivateProfileInt(section, "JewelVisualRemoveOptionSuccessRate_AL3", 0, path);
