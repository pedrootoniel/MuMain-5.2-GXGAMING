...
void GDCharacterListRecv(SDHP_CHARACTER_LIST_RECV* lpMsg,int index) // OK
{
	...
	gQueryManager.GetAsString("GameID6", CharacterName[5], sizeof(CharacterName[5]));

	gQueryManager.GetAsString("GameID7", CharacterName[6], sizeof(CharacterName[6]));

	gQueryManager.GetAsString("GameID8", CharacterName[7], sizeof(CharacterName[7]));

	gQueryManager.GetAsString("GameID9", CharacterName[8], sizeof(CharacterName[8]));

	gQueryManager.GetAsString("GameID10", CharacterName[9], sizeof(CharacterName[9]));
