...
public:
	...
	int m_JewelVisualItemIndexAdd;
	int	m_JewelVisualItemIndexRemove;
	int	m_JewelVisualAddOptionSuccessRate[MAX_ACCOUNT_LEVEL];
	int	m_JewelVisualRemoveOptionSuccessRate[MAX_ACCOUNT_LEVEL];
